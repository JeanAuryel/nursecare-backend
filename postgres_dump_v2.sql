...
-- Conversion date: 2025-10-21T08:48:00.734Z
...
(TRUE, 'Actes de soins', NULL, 1, '2025-10-18 23:39:22'),
...
(TRUE, 'ESICAD', '56 chemin de la Roseraie', 'Toulouse', '31500', '05 61 23 45 78', 'contact@esicad-toulouse.fr', 'julie.martin@esicad-toulouse.fr', 1, '2025-10-18 23:04:17'),
...
(TRUE, 'Akinotcho', 'Jean-Auryel', 'jeanauryel.akinotcho@nursecare.fr', '$2b$10$ZU3djEQdGDDouYbrjSRcO.xzZ14XCjFP9fAIrYQNtEKQnginP5eHO', 'DIRECTEUR', '06 12 34 56 78', '12 rue du Languedoc', 'TOULOUSE', '31000', 1, '2025-10-14 16:03:08', '2025-10-18 15:10:45'),
...
(TRUE, 'F2025-001', 1, '2025-01-02', '2025-02-01', 20.00, 1.10, 21.10, 21.10, 'PAYEE', '', '2025-01-02', 'Paiement immédiat', '2025-10-19 17:25:27', '2025-10-19 17:25:27'),
...
(TRUE, 1, 1, NULL, '', 1, 20.00, 20.00, 5.50, 1.10, 21.10),
...
(TRUE, 'Lambert', 'Élodie', '14 rue Raymond IV', 'Toulouse', '31000', '06 71 45 28 90', 'elodie.lambert@example.com', '297041523456789', '1997-04-15', 1, '2025-10-13 22:00:00', '2025-10-13 22:00:00'),
...
(TRUE, 'Pose / retrait d’une attelle', 'Application ou retrait d’une attelle pour immobilisation temporaire d’un membre.', 15.00, 20, 1, 1, '2025-10-13 22:00:00', '2025-10-13 22:00:00'),
...
(TRUE, 2, 1, 1, NULL, '2025-01-02 09:00:00', '2025-01-02 09:05:00', '2025-01-02 09:30:00', NULL, 'Planifie', NULL, NULL, NULL, NULL, NULL, 5, 5, '2025-10-19 07:20:52', '2025-10-19 16:50:33'),
...
,"nombre_rdv_planifies" decimal(22,FALSE)
,"nombre_rdv_termines" decimal(22,FALSE)
...
ALTER TABLE "Categorie"
  MODIFY "idCategorie" SERIAL, =4;

ALTER TABLE "Ecole"
  MODIFY "idEcole" SERIAL;

ALTER TABLE "Employe"
  MODIFY "idEmploye" SERIAL;

ALTER TABLE "Facture"
  MODIFY "idFacture" SERIAL, =15;

ALTER TABLE "LigneFacture"
  MODIFY "idLigne" SERIAL, =15;

ALTER TABLE "Patient"
  MODIFY "idPatient" SERIAL;

ALTER TABLE "Prestation"
  MODIFY "IdPrestation" SERIAL;

ALTER TABLE "RDV"
  MODIFY "idRDV" SERIAL;

ALTER TABLE "Stagiaire"
  MODIFY "idStagiaire" SERIAL;
...
SELECT setval('"Categorie_id_seq"', (SELECT MAX(id) FROM "Categorie") + 1, false);
SELECT setval('"Ecole_id_seq"', (SELECT MAX(id) FROM "Ecole") + 1, false);
SELECT setval('"Employe_id_seq"', (SELECT MAX(id) FROM "Employe") + 1, false);
SELECT setval('"Facture_id_seq"', (SELECT MAX(id) FROM "Facture") + 1, false);
SELECT setval('"LigneFacture_id_seq"', (SELECT MAX(id) FROM "LigneFacture") + 1, false);
SELECT setval('"Patient_id_seq"', (SELECT MAX(id) FROM "Patient") + 1, false);
SELECT setval('"Prestation_id_seq"', (SELECT MAX(id) FROM "Prestation") + 1, false);
SELECT setval('"RDV_id_seq"', (SELECT MAX(id) FROM "RDV") + 1, false);
SELECT setval('"Stagiaire_id_seq"', (SELECT MAX(id) FROM "Stagiaire") + 1, false);
SELECT setval('"VueFacturesCompletes_id_seq"', (SELECT MAX(id) FROM "VueFacturesCompletes") + 1, false);
SELECT setval('"VueLignesFacturesCompletes_id_seq"', (SELECT MAX(id) FROM "VueLignesFacturesCompletes") + 1, false);
SELECT setval('"v_activite_par_categorie_id_seq"', (SELECT MAX(id) FROM "v_activite_par_categorie") + 1, false);
SELECT setval('"v_charge_travail_infirmiers_id_seq"', (SELECT MAX(id) FROM "v_charge_travail_infirmiers") + 1, false);
SELECT setval('"v_factures_en_attente_id_seq"', (SELECT MAX(id) FROM "v_factures_en_attente") + 1, false);
SELECT setval('"v_notes_par_ecole_id_seq"', (SELECT MAX(id) FROM "v_notes_par_ecole") + 1, false);
SELECT setval('"v_notes_stagiaires_id_seq"', (SELECT MAX(id) FROM "v_notes_stagiaires") + 1, false);
SELECT setval('"v_planning_infirmiers_id_seq"', (SELECT MAX(id) FROM "v_planning_infirmiers") + 1, false);

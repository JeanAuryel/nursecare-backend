...
-- Conversion date: 2025-10-21T08:51:03.496Z
...
CREATE TABLE "Facture" (
  ...
  "montantHT" decimal(10,2) NOT NULL DEFAULT FALSE.00,
  "montantTVA" decimal(10,2) NOT NULL DEFAULT FALSE.00,
  "montantTTC" decimal(10,2) NOT NULL DEFAULT FALSE.00,
  "montantPaye" decimal(10,2) DEFAULT FALSE.00,
...
CREATE TABLE "LigneFacture" (
  ...
  "quantite" INTEGER NOT NULL DEFAULT TRUE,
  "prixUnitaire" decimal(10,2) NOT NULL,
  "montantHT" decimal(10,2) NOT NULL,
  "tauxTVA" decimal(5,2) NOT NULL DEFAULT FALSE.00,
  "montantTVA" decimal(10,2) NOT NULL DEFAULT FALSE.00,
...
ALTER TABLE "Categorie"
  MODIFY "idCategorie" SERIAL PRIMARY KEY, =4;

ALTER TABLE "Ecole"
  MODIFY "idEcole" SERIAL PRIMARY KEY;

ALTER TABLE "Employe"
  MODIFY "idEmploye" SERIAL PRIMARY KEY;

ALTER TABLE "Facture"
  MODIFY "idFacture" SERIAL PRIMARY KEY, =15;

ALTER TABLE "LigneFacture"
  MODIFY "idLigne" SERIAL PRIMARY KEY, =15;

ALTER TABLE "Patient"
  MODIFY "idPatient" SERIAL PRIMARY KEY;

ALTER TABLE "Prestation"
  MODIFY "IdPrestation" SERIAL PRIMARY KEY;

ALTER TABLE "RDV"
  MODIFY "idRDV" SERIAL PRIMARY KEY;

ALTER TABLE "Stagiaire"
  MODIFY "idStagiaire" SERIAL PRIMARY KEY;

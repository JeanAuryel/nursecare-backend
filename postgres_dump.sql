...
CREATE TABLE "Stagiaire" (
  "idStagiaire" SERIAL PRIMARY KEY,
...
--
ALTER TABLE "Categorie"
  MODIFY "idCategorie" INTEGER NOT NULL , =4;

--
--  for table "Ecole"
--
ALTER TABLE "Ecole"
  MODIFY "idEcole" INTEGER NOT NULL ;

--
--  for table "Employe"
--
ALTER TABLE "Employe"
  MODIFY "idEmploye" INTEGER NOT NULL ;

--
--  for table "Facture"
--
ALTER TABLE "Facture"
  MODIFY "idFacture" INTEGER NOT NULL , =15;

--
--  for table "LigneFacture"
--
ALTER TABLE "LigneFacture"
  MODIFY "idLigne" INTEGER NOT NULL , =15;

--
--  for table "Patient"
--
ALTER TABLE "Patient"
  MODIFY "idPatient" INTEGER NOT NULL ;

--
--  for table "Prestation"
--
ALTER TABLE "Prestation"
  MODIFY "IdPrestation" INTEGER NOT NULL ;

--
--  for table "RDV"
--
ALTER TABLE "RDV"
  MODIFY "idRDV" INTEGER NOT NULL ;

--
--  for table "Stagiaire"
--
ALTER TABLE "Stagiaire"
  MODIFY "idStagiaire" INTEGER NOT NULL ;
